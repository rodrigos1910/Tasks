...
class RetrofitClient private constructor() {
    ...
    companion object{
        ...
        private fun getRetrofitInstance() : Retrofit{
            ...
            //adiciona um interceptador na chamada para incluir os headers no request
            httpClient.addInterceptor(object : Interceptor{
                override fun intercept(chain: Interceptor.Chain): Response {
                    val request =  chain.request()
                        .newBuilder()
                        .addHeader(TaskConstants.HEADER.TOKEN_KEY,token)
                        .addHeader(TaskConstants.HEADER.PERSON_KEY,key)
                        .build()
        ...
        //funcçao para adicionar header nas requisições

        fun addHeaders(tokenValue: String, keyValue: String){
            token = tokenValue
            key = keyValue
        }
